...
public class BoardExceptionTests {
    ...
    public void test_fill_method_exception() {
        ...
        Exception exception = assertThrows(IllegalArgumentException.class, () -> board.fill(newElements, GAME_MODE_2_PLAYERS));
    ...
    public void test_fill_method_exception_2() {
        ...
        Exception exception = assertThrows(IllegalArgumentException.class, () -> board.fill(newElements, GAME_MODE_3_PLAYERS));
    ...
    public void test_fill_method_exception_3() {
        ...
        Exception exception = assertThrows(IllegalArgumentException.class, () -> board.fill(newElements, GAME_MODE_4_PLAYERS));
    ...
    public void test_fill_method_doesnt_throw_exception() {
        ...
        assertDoesNotThrow(() -> board.fill(newElements, GAME_MODE_2_PLAYERS));
